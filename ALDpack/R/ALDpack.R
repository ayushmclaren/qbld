...
#' @return
#' \itemize{
#' \item {\code{rald_mix}} {returns a vector of random numbers from ALD(mu,sigma,p).}
#' \item {\code{dald_mix}} {returns returns density of AL(mu,sigma,p) at point x.}
#' \item {\code{pald_mix}} {returns CDF prob of AL(mu,sigma,p) at quantile q.}
#' \item {\code{qald_mix}} {returns inverse CDF quantile of AL(mu,sigma,p) at prob.}
#' }
#'
#' @examples
