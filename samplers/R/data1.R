...
#####
beta     = matrix(c(-2.5,3,2),nrow=3,ncol=1)       #true params for fixed effects
...
p = 0.25
epsilon  = matrix(rlogistic(m*n,0,1),nrow=m,ncol=n) ### ALD distbn on error terms
