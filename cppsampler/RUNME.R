...
sourceCpp("./k.cpp") ##sampler is here
...
mbm <- microbenchmark(datar = qbldcpp(nsim, p, y_r, x_r, s_r, x_intercept, s_intercept, b0, B0, c1, d1),datacpp = qbldcpp(nsim, p, y_cpp, x_cpp, s_cpp, x_intercept, s_intercept, b0, B0, c1, d1),times=1)
print(mbm)
